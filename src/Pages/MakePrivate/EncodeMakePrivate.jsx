...
import styles from './EncodeMakePrivate.module.css';
import loadingImg from './assets/loading.png';
import checkImg from './assets/check.png';
import { useNavigate } from 'react-router-dom';
import { ROUTES } from '../../Common/Routes';

export default function EncodeMakePrivate() {
      ...
      <div className={styles.body}>
                ...
                <div className={styles.stepItem}>
                    ...
                    <div className={styles.textBlock}>
                        ...
                        <ul className={styles.subList}>
                            ...
                            <li className={styles.active_mini}>· 개인 키 생성</li>
        ...
        <main className={styles.main}>
            ...
            <div className={styles.block}>
                <div className={styles.blockHeader}>개인 키 생성</div>
                <div className={styles.blockBody}>
                <p>{symmetricDone ? '개인 키 생성이 완료 되었습니다.' : '개인 키 생성 중 입니다.'}</p>
